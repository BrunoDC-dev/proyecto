        ...
        <div className="login_details">
            <div>
                <div className="login_flex">
                    ...
                    <input className="login_input" type="text" placeholder="Pedro Alfonso" required onChange={(event)=>setNameValue(event.target.value)} />
                </div>
                <div className="login_flex">
                    <div className="login_icon">
                    ...
                    <input className="login_input" type="number" placeholder="+5491130579898" required="required" onChange={(event)=>setPhoneValue(event.target.value)} />
                </div>
                <div className="login_flex">
                <div className="login_icon">
                    ...
                    <input className="login_input" type="email" placeholder="valentina@gmail.com" required="required" onChange={(event)=>setEmailValue(event.target.value)}/>
                </div>
            </div>
